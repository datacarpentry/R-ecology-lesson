...
### Querying a database with the SQL syntax
...
### Querying a database with the dplyr syntax
...
In this example, we first loaded all of the data into the R session by
...
Finally, to close the connection to the mammals database you may use 
