...
extended to other database types (a vignette in the dplyr package explains how
to do it).
...
entries. If you need these functionalities, you will need to use the dedicated R
...
which to do the operations by creating the `surveys` object, and then we use the
...
information about the different plots surveyed by the reseachers. To access it,
...
**Importnat Note:** Without the `collect()` statement, only the first 10
