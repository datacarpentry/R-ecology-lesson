...
print the value by using parentheses or by typing the object name:
...
instance, we may want to convert this weight into pounds (weight in pounds is 2.2
...
A vector is the most common and basic data structure in R, and can be considered
