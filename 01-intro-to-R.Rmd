...
The default setting for most base functions that read data into R is to interpret
`NA` as a missing value. If there are multiple types of missing values in your
dataset, you can extend what R considers a missing value when it reads the file in.
To do this we supply additional values in the "na.strings" component of the command 
to read in the data:
