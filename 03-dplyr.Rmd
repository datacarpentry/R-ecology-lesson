...
This is referred to as a "tibble". As previously mentioned, tibbles are a special form of a data frame with several tweaks from the traditional data frame structure. These tweaks provide some benefits, particularly in regards to more easily manipulating data. For our purposes the most important differences are that:
