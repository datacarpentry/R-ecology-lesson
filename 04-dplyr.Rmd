...
>
> * List the six basic data manipulation 'verbs' in the dplyr package
> * Select subsets of columns from a dataframe, and filter rows 
according to a condition(s)
> * Link together a sequence of dplyr verbs using the 'pipe' operator
> * Create new columns of data by applying functions to existing columns 
using the 'mutate' command
> * Export a dataframe to a csv file using write.csv
