...
layout: topic title: Data visualisation with R
...
-	add `geoms` -- graphical representation of the data in the plot (points, lines, bars). To add a ageom to the plot use `+` operator:
...
Example of complex visualisation in which plot area is divided into hexagonal sections and points are counted wihin hexagons. The number of points per hexagon is encoded by color.
