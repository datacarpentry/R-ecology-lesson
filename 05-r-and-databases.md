...
```{.output}
#> src:  sqlite 3.45.0 [/home/runner/work/R-ecology-lesson/R-ecology-lesson/site/built/data_raw/portal_mammals.sqlite]
...
```{.output}
#> # Source:   SQL [10 x 9]
#> # Database: sqlite 3.45.0 [/home/runner/work/R-ecology-lesson/R-ecology-lesson/site/built/data_raw/portal_mammals.sqlite]
...
```{.output}
#> src:  sqlite 3.45.0 [/home/runner/work/R-ecology-lesson/R-ecology-lesson/site/built/data/portal-database-output.sqlite]
#> tbls:
```
