...
- We then access these numeric values using the underlying integers of the
  vector `year_fct` inside the square brackets. Notice this approach works
  precisely because `year_fct` is a factor as opposed to a numeric vector,
  unlike the other examples of subsetting in this lesson.
