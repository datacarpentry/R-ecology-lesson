...
As you go through this next section, you may want to point out what is happening in the environment pane. For example, the functions `nrow()` and `ncol()` correspond with 'observation' and 'variables' in the environment pane. This can help learners make connections between the different sections of the R interface and identify ways to double check their work. 
