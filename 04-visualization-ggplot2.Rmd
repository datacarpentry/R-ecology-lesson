...
Note that combining the geom_boxplot and geom_jitter layers together can cause 
outlier points to be plotted twice - once as outliers for the boxplot and once 
again by jitter. To prevent duplication of points in this example, the geom_boxplot 
layer outlier.shape argument is set to NA.
