...
**`ggplot2`** plots work best with data in the 'long' format, i.e., a column for every dimension,
...
- You may notice that we sometimes reference 'ggplot2' and sometimes 'ggplot'.
  To clarify, 'ggplot2' is the name of the most recent library version.
