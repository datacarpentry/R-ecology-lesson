...
- The first and second arguments in a ggplot function are data and mapping (x-axis and y-axis). As long as you 
  specify the arguments in correct order, you don't need to specify them as data= or mapping=.
  ggplot(surveys_complete, aes(x = weight, y = hindfoot_length)) gives the same result as
  ggplot(data = surveys_complete, mapping = aes(x = weight, y = hindfoot_length))
...
Note: You can use the up key in your keyboard to display the previous command you typed on your console. This 
      helps save a lot of typing, especially when you are playing around with your plot displays.
