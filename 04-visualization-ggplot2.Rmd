...
In the previous lesson we saw how to use the pipe operator `%>%` to implement
different functions in a sequence and create a coherent workflow.
Much like in consecutive data manipulations, the pipe operator can be integrated in the `ggplot()` function.
