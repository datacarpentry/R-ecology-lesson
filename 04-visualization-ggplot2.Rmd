...
from data in a dataframe. It provides a more programmatic interface for 
...
> on the number of observations that fall within its boundaries.  To use
...
Timelapse data can be visualised as a line plot with years on the x axis and counts
on the y axis:
...
increasing the font size. While we're at it, we'll also change the font family:
