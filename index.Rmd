...
the `tidyverse` package from within RStudio. Follow the instructions below for your
...
* To check which version of R you are using, start RStudio and the first thing
  that appears in the console indicates the version of R you are running. Go on
...
**In any case you will also need to install the "tidyverse" and "RSQLite" packages.**
