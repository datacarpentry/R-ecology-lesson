...
>[mammals
data](http://figshare.com/articles/Portal_Project_Teaching_Database/1314459)
...
```{r number_spicies_year_with_right_labels}
ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex, group = sex)) +
  geom_line() + 
...
```{r number_spicies_year_with_right_labels_xfont_size}
ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex, group = sex)) +
  geom_line() + 
  facet_wrap(~ species_id) + 
  labs(title = 'Observed species in time', 
