...
R is widely used in academia and in companies in industries such as pharma and biotech.
...
[RStudio community](https://community.rstudio.com/), and Slack channels such as the 
...
such as the R Ladies Global(https://rladies.org/). 
