...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.cap="RStudio interface screenshot. Clockwise from top left: Source, Environment/History, Files/Plots/Packages/Help/Viewer, Console."}
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Set 'Save workspace to .RData on exit' to 'Never'"}
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.cap="How it should look like at the beginning of this lesson"}
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.cap="RStudio help panel. When typing a word in the search field, it will show related suggestions."}
...
```{r, echo=FALSE, out.width="400px", fig.align="center", fig.cap="RStudio shows a red x next to a line of code that R doesn't understand."}
knitr::include_graphics("img/rstudioredx.png")
```
...
```{r kitten-img, echo=FALSE, out.width="400px", fig.align="center"}
