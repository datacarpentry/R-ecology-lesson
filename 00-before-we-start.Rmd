...
Workspace is your current working environment in R which includes any user-defined object, which will be saved and automatically loaded when you reopen your project.RStudio's default preferences generally work well, but saving a workspace to
