...
After our manipulations we notice that the values on the x-axis are still not properly readable.
...
ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex, group = sex)) +
  ...
  theme_bw() + 
  theme( 
        axis.text.x = element_text(colour="grey20",size=12,angle=90,hjust=.5,vjust=.5),
