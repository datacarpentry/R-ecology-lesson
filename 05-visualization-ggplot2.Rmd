...
Now, labels have become bigger and more readable, but there are still few things
that could be improved. Please, take another five minutes and try to
add another one or two things to make it look even more beautiful.
Use the ggplot2 cheat sheet, which we linked earlier for inspiration.
