...
First, lets check if our data directory exists, and create it if necessary:

```{r purl=TRUE}
if (! file.exists("data")) dir.create("data")
```
This creates the directory "data" in your working directory. 

Next, to download the data into the `data/` subdirectory, do:
