...
Converting factors where the levels appear as numbers (such as in
concentration levels) to a numeric vector needs some additional steps.  One method is to convert factors to characters and then numbers.  A better way is to use the levels() function. Compare:
