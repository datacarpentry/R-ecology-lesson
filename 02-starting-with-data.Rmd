...
##
## * How an you create a similar plot for the first 5 treatments and exclude the "control" from the plot?
...
barplot(table(exprmt))
## * By subseting the values of a factor and creating a new factor using the function factor().
barplot(table(factor(exprmt[1:5])))
```
-->
