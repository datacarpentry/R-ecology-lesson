...
concentration levels) to a numeric vector is a little trickier.  One method is to convert factors to characters and then numbers.  A better way is to use the `levels()` function. Compare:
