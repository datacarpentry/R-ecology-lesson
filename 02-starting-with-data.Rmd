...
you'll download the file. The easiest way to create a directory folder in your
project is to use dir.create("folder_name"). So this command downloads a file from
Figshare, names it "portal_data_joined.csv" and adds it to a preexisting folder 
named "data_raw".
