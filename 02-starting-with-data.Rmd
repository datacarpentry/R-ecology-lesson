...
> of looking at and record some parameters of your csv files. As an example, 
> the character encoding, control characters used for line ending, and date format
> (if the date is not splitted into three variables), and the presence of unexepected
> [newlines](https://en.wikipedia.org/wiki/Newline) in your data file.
> Those parameters will ease up the import step of you data and R.
