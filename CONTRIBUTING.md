...
4.  Make your changes, commit them (`git add file-you-changed.Rmd`, followed by `git commit -m "fix typos in dplyr lesson"`), and push them to your
    repository on GitHub (`git push origin fix-typos-dplyr-lesson`).
