# Data visualization with ggplot2 {#vis-ggplot2}
...
You can make plots interactive by simply passing the ggplot2 object to the plotly library's [ggplot2](https://plot.ly/ggplot2/) function. This is most useful for dense plots in which you wish to inspect a plot's individual elements interactively, such as outliers in a scatterplot.

This only works when outputting to HTML, since it takes advantage of the [htmlwidgets](http://www.htmlwidgets.org/) framework.
...
```{r plotly scatterplot, results='asis'}
...
![Popup information on hover for scatterplot rendered through `plotly::ggplotly()`](./img/ggplot2-plotly_scatterplot-hover.png)

You can similarly make any other ggplot2 interactive, such as for a box plot:
  
```{r plotly boxplot, results='asis'}
# box plot
...
```{r plotly line graph, results='asis'}
# line graph
...
For more options, please visit [plot.ly/ggplot2](https://plot.ly/ggplot2/).