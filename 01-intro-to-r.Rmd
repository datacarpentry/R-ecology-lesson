...
be read as 3 **goes into** `x`. The arrow can also change direction for instance, `->` in this case executing `3 -> x` does the same job as executing `x <- 3`. For historical reasons, you can also use `=`
