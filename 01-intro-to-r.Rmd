...
We could also look at the help for this function using `?round`.
...
weight_g[weight_g > 50]  # so we can use this to select only the values above 50
```
...
```{r, echo=FALSE, purl=TRUE}
## ### Challenge
## 1. Using this vector of heights in inches, create a new vector with the NAs 
## removed.
##
##    heights <- c(63, 69, 60, 65, NA, 68, 61, 70, 61, 59, 64, 69, 
##                 63, 63, NA, 72, 65, 64, 70, 63, 65)
