...
#>  [1] RSQLite_2.3.5   lubridate_1.9.3 forcats_1.0.0   stringr_1.5.1  
#>  [5] dplyr_1.1.4     purrr_1.0.2     readr_2.1.5     tidyr_1.3.1    
#>  [9] tibble_3.2.1    ggplot2_3.5.0   tidyverse_2.0.0 knitr_1.45     
#> 
#> loaded via a namespace (and not attached):
#>  [1] bit_4.0.5        gtable_0.3.4     compiler_4.3.2   renv_1.0.5      
#>  [5] highr_0.10       tidyselect_1.2.0 blob_1.2.4       scales_1.3.0    
#>  [9] fastmap_1.1.1    yaml_2.3.8       R6_2.5.1         generics_0.1.3  
#> [13] munsell_0.5.0    DBI_1.2.2        pillar_1.9.0     tzdb_0.4.0      
#> [17] rlang_1.1.3      utf8_1.2.4       cachem_1.0.8     stringi_1.8.3   
#> [21] xfun_0.42        bit64_4.0.5      memoise_2.0.1    timechange_0.3.0
#> [25] cli_3.6.2        withr_3.0.0      magrittr_2.0.3   grid_4.3.2      
#> [29] hms_1.1.3        lifecycle_1.0.4  vctrs_0.6.5      evaluate_0.23   
#> [33] glue_1.7.0       fansi_1.0.6      colorspace_2.1-0 tools_4.3.2     
#> [37] pkgconfig_2.0.3
```
